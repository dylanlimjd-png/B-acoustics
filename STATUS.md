...
| 37 | **NEW - Internal-linking improvements** (descriptive anchors, more in-body links to unindexed pages) | Med | Low | Audit 2026-09-21 found sitewide links complete but in-body links uneven (home theatre + neighbour-noise posts have 1 each) and generic anchors ("Learn more", "See our services"). Four fixes proposed, not built. | `CONTINUOUS_IMPROVEMENT.md` Week of 2026-09-21 |
