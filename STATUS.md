...
|---|---|---|---|---|---|
| 1 | First GBP reviews — solicit from real clients | Very High | Low (for you) | **Reversed 2026-08-07**: the GBP listing exists and is live (`b-acoustics.com` correctly linked, 3 owner photos, 1 five-star review already). **New blocker found**: the listing's phone number (8784 7481) doesn't match the website's (+65 9641 6999) — needs you to confirm which is current and fix the other side. Also no address shown on GBP (likely service-area setup) — confirm intentional. Keep soliciting reviews; 1 isn't many yet. | `SEO_RECOMMENDATIONS.md` 2026-08-07 entry |
