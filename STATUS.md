...
| ~~35~~ | ~~Blog hub + all 3 service pages' `og:image`/`twitter:image` still point at the plain logo~~ | Med | Low | **DONE 2026-09-21 (code, unpushed)**: blog hub uses the real Ultra Studio photo, office page the real office photo, party-wall and industrial their own hero images (AI-generated, no real photo yet). Same fix already done for the homepage 2026-08-26 — never carried to the rest of the site. Needs picking a relevant real photo per page (small design call), queued not built. | `CONTINUOUS_IMPROVEMENT.md` Week of 2026-09-06 |
| ~~37~~ | ~~**NEW - Internal-linking improvements** (descriptive anchors, more in-body links to unindexed pages)**~~ | Med | Low | Audit 2026-09-21 found sitewide links complete but in-body links uneven (home theatre + neighbour-noise posts have 1 each) and generic anchors ("Learn more", "See our services"). **BUILT 2026-09-21**: descriptive homepage anchors, blog-hub body link, and new in-body links to the home theatre, neighbour-noise, office and industrial pages. | `CONTINUOUS_IMPROVEMENT.md` Week of 2026-09-21 |
| 36 | **NEW - Ads campaign Eligible but served 0 impressions and SGD0 spend 14-20 Sep; conversion status shows tag inactive, unverified, 0 recording** | High | Low-Med | Found 2026-09-21 after verification cleared. Likely the verification pause carried over and delivery may resume; re-check in 2-3 days. If still 0, investigate (billing balance SGD118.38 is fine; a leftover draft campaign "Leads-Performance Max-2" exists, harmless). Also: SGD600 credit offer expires 24 Sep, SGD230 away, unlikely to hit. | This session. **Budget lowered SGD15 to SGD10/day on 2026-09-21 at the user's request.** |
